public class Grass extends Plant {
    ...
    static {
        liveLength = 5;
        sign = new String(Character.toChars(0x1F33F));
        speciesPower = 2;
    ...
    public static void setSpeciesPower(int speciesPower) {
        Grass.speciesPower = speciesPower;
    }

    public static void setSpeciesReproduceChance(int speciesReproduceChance) {
        Grass.speciesReproduceChance = speciesReproduceChance;
    }
    ...
    public static void setSign(int sign) {
        Grass.sign = new String(Character.toChars(sign));
    }
    ...
    public static void setLiveLength(int liveLength) {
        Grass.liveLength = liveLength;
    }

    @Override
    protected Object clone() {
        return new Grass(0, 0, world);
    }
